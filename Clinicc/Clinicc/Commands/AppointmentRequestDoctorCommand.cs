...
{
    public class AppointmentRequestDoctorCommand:CommandBase
    {
        private Hospital _hospital;
        private NavigationStore _navigation;
        private Clinicc.Model.Doctor _doc;

        public AppointmentRequestDoctorCommand(Hospital hospital, NavigationStore navigation, Model.Doctor doc)
        {
            _hospital = hospital;
